...
int main()
{
	...
	// This was the original way of displaying each line
	// But I realized I could just use cout to display each individual aspect of the line
	/*
